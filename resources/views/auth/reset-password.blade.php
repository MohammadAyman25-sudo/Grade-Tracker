        ...
        <div
            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                ...
                <main class="mt-7 flex flex-col items-center">
                    ...
                    @endif
                    @if($errors->any())
                        <div class="p-4 mt-10 text-md text-red-800 rounded-lg bg-red-50 dark:bg-gray-800 dark:text-red-400">
                            <ul>
                    ...
                    @endif
                    <form action="{{ route('password.update') }}" method="POST" class="max-w-lg mx-auto my-10 w-full">
                        @csrf
