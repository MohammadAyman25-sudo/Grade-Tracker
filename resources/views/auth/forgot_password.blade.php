            ...
            <div class="relative w-full max-w-2xl px-6 lg:max-w-7xl">
                <main class="mt-7 flex flex-col items-center">
                    ...
                    @if(session('status') !== null)
                        <div class="p-4 mt-10 text-sm text-green-800 rounded-lg bg-green-50 dark:bg-gray-800 dark:text-green-400" role="alert">
                    ...
                    @endif
                    <form action="{{ route('forgot-password') }}" method="POST" class="max-w-lg mx-auto my-10 w-full">
                        @csrf
                        <div class="relative mb-4">
                            <input type="email" id="email"
                                class="block px-2.5 pb-2.5 pt-4 w-full text-md text-gray-900 bg-transparent rounded-lg border-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
                                placeholder=" " name="email" required/>
                            <label for="email"
                                class="absolute text-md font-semibold
                        ...
                        <button type="submit"
                            class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-md w-full sm:w-auto px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Submit</button>
                    </form>
                </main>
            </div>
        </div>
